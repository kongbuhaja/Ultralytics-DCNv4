...
task deco-yolo10n "0-15" 0 "$log_dir" # 2,782,256
task deco-yolo11n "16-31" 1 "$log_dir" # 2,660,752

task psd-yolo10n "32-47" 2 "$log_dir" # 2,780,720
task c2psd-yolo11n "48-63" 3 "$log_dir" # 2,629,280

# task deco-psd-yolo10n "$log_dir" # 2,787,456
# task deco-c2psd-yolo11n "$log_dir" # 2,665,952
